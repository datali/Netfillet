 ...
 */
@WebServlet("/ManagerMovieListByCustNameServlet")
public class ManagerMovieListByCustNameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerMovieListByCustNameServlet() {
        super();
