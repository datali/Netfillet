            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="/FinalProject305/manager_admin/html/most_rented_movie_list.jsp" class="active" class="waves-effect"><i class="fa fa-line-chart fa-fw" aria-hidden="true"></i>Most Rented Movies</a>
                    </li>
