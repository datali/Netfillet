        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/FinalProject305/manager_admin/html/add_employee.jsp" class="active" class="waves-effect"><i class="fa fa-plus-circle fa-fw" aria-hidden="true"></i>Add Employee</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="/FinalProject305/ManagerAddEmployeeServlet" role="form" class="form-horizontal form-material" method="POST">
                                <div class="form-group">
                                    <label class="col-md-12">Employee ID</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="employeeId"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">SSN</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="ssn"> </div>
                                </div>
                                <div class="form-group">
                                    <label  class="col-md-12">Start Date</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="startDate"> </div>
                                </div>
                                <div class="form-group">
                                    <label  class="col-md-12">Hourly Rate</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="hourlyRate"> </div>
                                </div>
                            
                             	<div class="form-group">
                                    <div class="col-sm-12">
                                        <input type="submit" value="Add Employee" class="btn btn">
                                    </div>
                                </div>
                            </form>
                        </div>
