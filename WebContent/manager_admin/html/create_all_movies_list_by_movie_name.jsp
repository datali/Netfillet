        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/FinalProject305/manager_admin/html/create_all_movies_list_by_movie_name.jsp" class="active" class="waves-effect"><i class="fa fa-sort-alpha-asc fa-fw" aria-hidden="true"></i>Movie List by Name</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Movie List by Movie Name</h4> </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="/FinalProject305/ManagerMovieListByNameServlet" role="form" class="form-horizontal form-material" method="POST">
                                <div class="form-group">
                                    <label class="col-md-12">Movie Name</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="movieName"> </div>
                                </div>
                                
                             	<div class="form-group">
                                    <div class="col-sm-12">
                                        <input type="submit" value="Create List" class="btn">
                                    </div>
                                </div>
                            </form>
                        </div>
