        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/FinalProject305/manager_admin/html/most_oversaw_transaction_employee.jsp" class="active" class="waves-effect"><i class="fa fa-star fa-fw" aria-hidden="true"></i>Most Transaction Oversawed Customer Representative</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Most Transaction Oversawed Employee</h4> </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                             <form action="/FinalProject305/ManagerMostTransactionOversawEmployeeServlet" role="form" class="form-horizontal form-material" method="POST">
