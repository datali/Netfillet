        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/FinalProject305/manager_admin/html/create_all_movies_list_by_movie_type.jsp" class="active" class="waves-effect"><i class="fa fa-sitemap fa-fw" aria-hidden="true"></i>Movie List by Type</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Movie List by Movie Type</h4> </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="/FinalProject305/ManagerMovieListByTypeServlet" role="form" class="form-horizontal form-material" method="POST">
                                <div class="form-group">
                                    <label class="col-md-12">Movie Type</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="movieType"> </div>
                                </div>
                             	<div class="form-group">
                                    <div class="col-sm-12">
