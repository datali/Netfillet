        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="employee_admin/html/create_movie_suggestion_list.jsp" class="active" class="waves-effect"><i class="fa fa-list fa-fw" aria-hidden="true"></i>Create movie suggestion</a>
                    </li>
