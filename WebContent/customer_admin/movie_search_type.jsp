        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/FinalProject305/customer_admin/movie_search_type.jsp" class="active" class="waves-effect"><i class="fa fa-search fa-fw" aria-hidden="true"></i>Search Movie by Genres</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="/FinalProject305/CustomerSearchGenresServlet" role="form" class="form-horizontal form-material" method="POST">
                                <div class="form-group">
                                    <label class="col-md-12">Genres</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="genres"></div>
                                </div>
                             	<div class="form-group">
                                    <div class="col-sm-12">
